...
public:
    ...
    // Компилятор сам сгенерирует реализацию деструктора, = default более безопасен, чем пустое тело {}, предотвращает потенциальные утечки
    ...
    // const предотвращает ненужное копирование строки
